...
* Added reproducible one-row pUC19c, pBR322 and pBluescript II SK(+) sequence
  ...
  annotations embedded in the three example `.dna` files provide an exact
  known-sequence layer, correcting incomplete matches such as the pBluescript
  II SK(+) lacZα and AmpR bounds. Complete REBASE 609
