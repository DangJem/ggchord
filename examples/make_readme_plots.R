...
# ---------------------------------------------------------------------------
seq2 <- seq_data_example[seq_data_example$accver %in% c("MT108731.1", "MT118296.1"), ]
ribbon2 <- ribbon_data_example[
  ribbon_data_example$qaccver %in% seq2$accver &
  ribbon_data_example$saccver %in% seq2$accver, ]
gene2 <- gene_data_example[gene_data_example$accver %in% seq2$accver, ]
save_plot(
  ggchord(seq2, ribbon2, gene2) + geom_seq() + geom_ribbon() + geom_gene() + geom_axis(),
  "example_seq2.png")

seq3 <- seq_data_example[seq_data_example$accver %in% c("MT108731.1", "MT118296.1", "OQ646790.1"), ]
ribbon3 <- ribbon_data_example[
  ribbon_data_example$qaccver %in% seq3$accver &
  ribbon_data_example$saccver %in% seq3$accver, ]
gene3 <- gene_data_example[gene_data_example$accver %in% seq3$accver, ]
save_plot(
