...
stress test. Real sites retain their anchors while measured label boxes form
a common radial offset contour; only collision-bound clusters rise to a nearby
outer contour. Each site keeps an independent radial stub and fan segment, or a
direct connector when no fan-out is needed. Leaders are clipped to the actual
text-box edge:
