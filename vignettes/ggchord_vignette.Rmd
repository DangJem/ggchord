...
stress test. Real sites retain their anchors while the shared outer trunk
spreads label slots deterministically:
...
Ribbon `link_avoid` defaults to local `smooth` avoidance; use `none` to disable
it or `uniform` for one endpoint-wide clearance. Explicit gaps win.
