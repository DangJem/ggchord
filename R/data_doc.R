...
#'
#' Three independent one-row data frames generated byte-for-byte from the
#' unchanged FASTA records. Feature and restriction annotations are generated
